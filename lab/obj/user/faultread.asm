	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ec:	0f be 80 48 23 80 00 	movsbl 0x802348(%eax),%eax
  8001f3:	50                   	push   %eax
...
00800240 <vprintfmt>:
{
  ...
  80028c:	ff 24 85 80 24 80 00 	jmp    *0x802480(,%eax,4)
  ...
  800358:	8b 14 85 e0 25 80 00 	mov    0x8025e0(,%eax,4),%edx
  80035f:	85 d2                	test   %edx,%edx
  800361:	74 18                	je     80037b <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800363:	52                   	push   %edx
  800364:	68 3b 27 80 00       	push   $0x80273b
  800369:	53                   	push   %ebx
  80036a:	56                   	push   %esi
  ...
  80037b:	50                   	push   %eax
  80037c:	68 60 23 80 00       	push   $0x802360
  800381:	53                   	push   %ebx
  800382:	56                   	push   %esi
  ...
  8003a3:	b8 59 23 80 00       	mov    $0x802359,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b8a:	68 3f 26 80 00       	push   $0x80263f
  800b8f:	6a 23                	push   $0x23
  800b91:	68 5c 26 80 00       	push   $0x80265c
...
sys_ipc_recv(void *dstva)
{
  ...
  800db9:	68 3f 26 80 00       	push   $0x80263f
  800dbe:	6a 23                	push   $0x23
  800dc0:	68 5c 26 80 00       	push   $0x80265c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ebe:	ba e8 26 80 00       	mov    $0x8026e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ee0:	51                   	push   %ecx
  800ee1:	50                   	push   %eax
  800ee2:	68 6c 26 80 00       	push   $0x80266c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80113a:	53                   	push   %ebx
  80113b:	50                   	push   %eax
  80113c:	68 ad 26 80 00       	push   $0x8026ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801203:	53                   	push   %ebx
  801204:	50                   	push   %eax
  801205:	68 c9 26 80 00       	push   $0x8026c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012ab:	53                   	push   %ebx
  8012ac:	50                   	push   %eax
  8012ad:	68 8c 26 80 00       	push   $0x80268c
...
0080146d <devfile_write>:
{
  ...
  8014bf:	c3                   	ret    
	assert(n <= PGSIZE - (sizeof(int) + sizeof(size_t)));
  8014c0:	68 fc 26 80 00       	push   $0x8026fc
  8014c5:	68 29 27 80 00       	push   $0x802729
  8014ca:	68 94 00 00 00       	push   $0x94
  8014cf:	68 3e 27 80 00       	push   $0x80273e
  8014d4:	e8 6f 0a 00 00       	call   801f48 <_panic>
	assert(r <= n);
  8014d9:	68 49 27 80 00       	push   $0x802749
  8014de:	68 29 27 80 00       	push   $0x802729
  8014e3:	68 98 00 00 00       	push   $0x98
  8014e8:	68 3e 27 80 00       	push   $0x80273e
...
008014f2 <devfile_read>:
{
  ...
  801547:	c3                   	ret    
	assert(r <= n);
  801548:	68 49 27 80 00       	push   $0x802749
  80154d:	68 29 27 80 00       	push   $0x802729
  801552:	6a 7c                	push   $0x7c
  801554:	68 3e 27 80 00       	push   $0x80273e
  801559:	e8 ea 09 00 00       	call   801f48 <_panic>
	assert(r <= PGSIZE);
  80155e:	68 50 27 80 00       	push   $0x802750
  801563:	68 29 27 80 00       	push   $0x802729
  801568:	6a 7d                	push   $0x7d
  80156a:	68 3e 27 80 00       	push   $0x80273e
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801631:	68 5c 27 80 00       	push   $0x80275c
  801636:	53                   	push   %ebx
...
00801691 <_pipeisclosed>:
{
  ...
  8016d4:	50                   	push   %eax
  8016d5:	53                   	push   %ebx
  8016d6:	68 63 27 80 00       	push   $0x802763
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80196c:	68 7b 27 80 00       	push   $0x80277b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801d2c:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801d2d:	68 87 27 80 00       	push   $0x802787
  801d32:	68 29 27 80 00       	push   $0x802729
  801d37:	6a 62                	push   $0x62
  801d39:	68 9c 27 80 00       	push   $0x80279c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801d8a:	c3                   	ret    
	assert(size < 1600);
  801d8b:	68 a8 27 80 00       	push   $0x8027a8
  801d90:	68 29 27 80 00       	push   $0x802729
  801d95:	6a 6d                	push   $0x6d
  801d97:	68 9c 27 80 00       	push   $0x80279c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801f64:	56                   	push   %esi
  801f65:	50                   	push   %eax
  801f66:	68 c0 27 80 00       	push   $0x8027c0
  ...
  801f77:	e8 76 e1 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801f7c:	c7 04 24 3c 23 80 00 	movl   $0x80233c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802034:	74 dc                	je     802012 <ipc_send+0x1b>
	        panic("ipc_send: %e", r);
  802036:	50                   	push   %eax
  802037:	68 e4 27 80 00       	push   $0x8027e4
  80203c:	6a 45                	push   $0x45
  80203e:	68 f1 27 80 00       	push   $0x8027f1
