...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 00 	movl   $0x802300,0x803000
  800040:	23 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800117:	68 0f 23 80 00       	push   $0x80230f
  80011c:	6a 23                	push   $0x23
  80011e:	68 2c 23 80 00       	push   $0x80232c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800198:	68 0f 23 80 00       	push   $0x80230f
  80019d:	6a 23                	push   $0x23
  80019f:	68 2c 23 80 00       	push   $0x80232c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001da:	68 0f 23 80 00       	push   $0x80230f
  8001df:	6a 23                	push   $0x23
  8001e1:	68 2c 23 80 00       	push   $0x80232c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021c:	68 0f 23 80 00       	push   $0x80230f
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80025e:	68 0f 23 80 00       	push   $0x80230f
  800263:	6a 23                	push   $0x23
  800265:	68 2c 23 80 00       	push   $0x80232c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a0:	68 0f 23 80 00       	push   $0x80230f
  8002a5:	6a 23                	push   $0x23
  8002a7:	68 2c 23 80 00       	push   $0x80232c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e2:	68 0f 23 80 00       	push   $0x80230f
  8002e7:	6a 23                	push   $0x23
  8002e9:	68 2c 23 80 00       	push   $0x80232c
...
sys_ipc_recv(void *dstva)
{
  ...
  800346:	68 0f 23 80 00       	push   $0x80230f
  80034b:	6a 23                	push   $0x23
  80034d:	68 2c 23 80 00       	push   $0x80232c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80044b:	ba b8 23 80 00       	mov    $0x8023b8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80046d:	51                   	push   %ecx
  80046e:	50                   	push   %eax
  80046f:	68 3c 23 80 00       	push   $0x80233c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006c7:	53                   	push   %ebx
  8006c8:	50                   	push   %eax
  8006c9:	68 7d 23 80 00       	push   $0x80237d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800790:	53                   	push   %ebx
  800791:	50                   	push   %eax
  800792:	68 99 23 80 00       	push   $0x802399
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800838:	53                   	push   %ebx
  800839:	50                   	push   %eax
  80083a:	68 5c 23 80 00       	push   $0x80235c
...
008009fa <devfile_write>:
{
  ...
  800a4c:	c3                   	ret    
	assert(n <= PGSIZE - (sizeof(int) + sizeof(size_t)));
  800a4d:	68 cc 23 80 00       	push   $0x8023cc
  800a52:	68 f9 23 80 00       	push   $0x8023f9
  800a57:	68 94 00 00 00       	push   $0x94
  800a5c:	68 0e 24 80 00       	push   $0x80240e
  800a61:	e8 6f 0a 00 00       	call   8014d5 <_panic>
	assert(r <= n);
  800a66:	68 19 24 80 00       	push   $0x802419
  800a6b:	68 f9 23 80 00       	push   $0x8023f9
  800a70:	68 98 00 00 00       	push   $0x98
  800a75:	68 0e 24 80 00       	push   $0x80240e
...
00800a7f <devfile_read>:
{
  ...
  800ad4:	c3                   	ret    
	assert(r <= n);
  800ad5:	68 19 24 80 00       	push   $0x802419
  800ada:	68 f9 23 80 00       	push   $0x8023f9
  800adf:	6a 7c                	push   $0x7c
  800ae1:	68 0e 24 80 00       	push   $0x80240e
  800ae6:	e8 ea 09 00 00       	call   8014d5 <_panic>
	assert(r <= PGSIZE);
  800aeb:	68 20 24 80 00       	push   $0x802420
  800af0:	68 f9 23 80 00       	push   $0x8023f9
  800af5:	6a 7d                	push   $0x7d
  800af7:	68 0e 24 80 00       	push   $0x80240e
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bbe:	68 2c 24 80 00       	push   $0x80242c
  800bc3:	53                   	push   %ebx
...
00800c1e <_pipeisclosed>:
{
  ...
  800c61:	50                   	push   %eax
  800c62:	53                   	push   %ebx
  800c63:	68 33 24 80 00       	push   $0x802433
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ef9:	68 4b 24 80 00       	push   $0x80244b
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8012b9:	c3                   	ret    
		assert(r < 1600 && r <= len);
  8012ba:	68 57 24 80 00       	push   $0x802457
  8012bf:	68 f9 23 80 00       	push   $0x8023f9
  8012c4:	6a 62                	push   $0x62
  8012c6:	68 6c 24 80 00       	push   $0x80246c
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801317:	c3                   	ret    
	assert(size < 1600);
  801318:	68 78 24 80 00       	push   $0x802478
  80131d:	68 f9 23 80 00       	push   $0x8023f9
  801322:	6a 6d                	push   $0x6d
  801324:	68 6c 24 80 00       	push   $0x80246c
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801368:	68 84 24 80 00       	push   $0x802484
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8014f1:	56                   	push   %esi
  8014f2:	50                   	push   %eax
  8014f3:	68 90 24 80 00       	push   $0x802490
  ...
  801504:	e8 56 00 00 00       	call   80155f <vcprintf>
	cprintf("\n");
  801509:	c7 04 24 44 24 80 00 	movl   $0x802444,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801659:	0f be 80 b3 24 80 00 	movsbl 0x8024b3(%eax),%eax
  801660:	50                   	push   %eax
...
008016ad <vprintfmt>:
{
  ...
  8017d0:	52                   	push   %edx
  8017d1:	68 0b 24 80 00       	push   $0x80240b
  8017d6:	53                   	push   %ebx
  8017d7:	56                   	push   %esi
  ...
  8017e8:	50                   	push   %eax
  8017e9:	68 cb 24 80 00       	push   $0x8024cb
  8017ee:	53                   	push   %ebx
  8017ef:	56                   	push   %esi
  ...
  801810:	b8 c4 24 80 00       	mov    $0x8024c4,%eax
